...
function draw() {
 fuckYou.fillStyle = 'hsla(0,0%,95%,.45)';
 fuckYou.fillRect(0, 0, c.width, c.height);
  txt();
  dst.ref();
  var pos = dst.pos;
...
//  
// // 
//   var gradient = fuckYou.createLinearGradient(0,0,100,0);
//   gradient.addColorStop(0,"green");
//   gradient.addColorStop(1,"red");

  fuckYou.strokeStyle = randomColor();
  var dist = _dist(p1, p2);
  fuckYou.globalAlpha = 1 - dist / 100;
  fuckYou.beginPath();
  fuckYou.moveTo(p1.x, p1.y);
  fuckYou.lineTo(p2.x, p2.y);
  fuckYou.stroke();
}
